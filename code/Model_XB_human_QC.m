function [ dYdT, Ftotal, F_active,F_passive,F_active_s,sov_thick, B_process, C_process, dCK, dK3, dCK_r, dPi_cons, dH_cons, dGly, dAdk] = Model_XB_human_QC(t,y,TmpC,SLset,par,iemg,dSL_set,Pcr0,H0)
...
K_T = 5.95619504335407;     % mM MgATP dissociation constant estimated by fitting Broxterman et al 2017 
%K_D = 0.4*0.194; % MgADP dissociation constant from Yamashita etal (Circ Res. 1994; 74:1027-33).
% K_D = 1*0.07; % mM
%K_D = par(20); % mM
K_D = 0.0582575861664175; % mM MgADP dissociation constant estimated by fitting Broxterman et al 2017
...
%Kh1 = par(18)*10^-7;
Kh1 = 0.000291703459793093; %mM proton dissociation constant estimated by fitting Broxterman et al 2017  
