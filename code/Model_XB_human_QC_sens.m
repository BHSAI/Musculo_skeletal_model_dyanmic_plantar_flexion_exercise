function [ dYdT, Ftotal, F_active,F_passive,F_active_s,sov_thick, B_process, C_process, dCK, dK3, dCK_r, dPi_cons, dH_cons, dGly, dAdk] = Model_XB_human_QC_sens(t,y,TmpC,SLset,par,iemg,dSL_set,Pcr0,H0)
...
K_Pi = par(21);    % mM Pi dissociation constant estimated by fitting Broxterman et al 2017
%K_T = 1*par(15);     % mM MgATP dissociation constant
K_T = par(22);     % mM MgATP dissociation constant estimated by fitting Broxterman et al 2017 
%K_D = 0.4*0.194; % MgADP dissociation constant from Yamashita etal (Circ Res. 1994; 74:1027-33).
% K_D = 1*0.07; % mM
%K_D = par(20); % mM
K_D = par(23); % mM MgADP dissociation constant estimated by fitting Broxterman et al 2017
...
%Kh1 = par(18)*10^-7;
Kh1 = par(24); %mM proton dissociation constant estimated by fitting Broxterman et al 2017  
